...
#define AD9833PORT GPIOB      // PORT OF AD9833
#define AD9833DATA GPIO_PIN_15 // SPI DATA PIN
#define AD9833SCK GPIO_PIN_13  // SPI Clock PIN
#define AD9833SS GPIO_PIN_14   // SPI Chip Select
